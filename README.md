...
Data Locale Parser is a package for Laravel 5.6 | 5.7 | 5.8 | 6.* | 7.* | 8.* | 9.*, which lists all countries, currencies and languages, with names and ISO 3166-1 codes in all languages and data formats.
