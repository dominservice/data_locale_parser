...
namespace Dominservice\CountryList\Fasade;
 ...
 * @method static \Dominservice\CountryList\DataParser setList(string $type, string $locale, array $data)
...
class DataParserFacade extends Facade
{
    ...
    {
        return \Dominservice\CountryList\DataParser::class;
    }
